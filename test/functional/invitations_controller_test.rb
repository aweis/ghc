...
class InvitationsControllerTest < ActionController::TestCase
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post :create, invitation: { approved: @invitation.approved, event_id: @invitation.event_id, user_id: @invitation.user_id }
    end
  ...
  test "should update invitation" do
    put :update, id: @invitation, invitation: { approved: @invitation.approved, event_id: @invitation.event_id, user_id: @invitation.user_id }
    assert_redirected_to invitation_path(assigns(:invitation))
  end
